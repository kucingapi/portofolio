  ...
  return (
    <Box mt="64px">
      ...
      >
        <Grid container spacing={2}>
          <Grid
            ...
            xs={12}
            md={6}
            className={`${classes.itemMiddle} ${classes.itemText}`}
          >
            <Box>
              <Typography variant="h4" gutterBottom={true}>
                Hi My name is{' '}
                <Box className={classes.boldText}>Novel Bafagih</Box>
              </Typography>
              <Typography variant="h4" gutterBottom={true}>
                I’m a <Box className={classes.boldText}>student</Box> in
                University of <Box className={classes.boldText}>Brawijaya </Box>
                and i’m a{' '}
                <Box className={classes.boldText}>Fullstack web developer </Box>
                enthusiast
              </Typography>
              <Typography variant="h4" gutterBottom={true}>
          ...
          <Grid
            ...
            xs={12}
            md={6}
            className={`${classes.itemMiddle} ${classes.itemImage}`}
          >
      ...
      >
        ...
        <Arrows style={{ width: '80px' }} className={classes.arrows} />
      </Stack>
    </Box>
  );
}
